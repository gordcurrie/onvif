...
import (
	...
	goonvif "github.com/gordcurrie/onvif"
	"github.com/gordcurrie/onvif/device"
	sdk "github.com/gordcurrie/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/gordcurrie/onvif/gosoap for pretty printing response
